...
```
  ...
  export HAL=stm32g0xx MCU=stm32g071   TARGET=thumbv6m-none-eabi    PROC=stm32g0   CHIP=STM32G071 # none-stm32g071      Cortex-M0
...
(or now simplified to `export INTERFACE=stlink`)  for a typical cheap dongle
