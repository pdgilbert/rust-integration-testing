...
pub fn setup() ->  (I2cType, I2c2Type, LedType, DelayType) {    
    //let cp = CorePeripherals::take().unwrap();
    let dp = Peripherals::take().unwrap();
    setup_i2c1_i2c2_led_delay_using_dp(dp)
}
...
#[cfg(feature = "stm32f0xx")]
pub fn setup_i2c1_i2c2_led_delay_using_dp(mut dp: Peripherals) ->  (I2cType, I2c2Type, LedType, DelayType) {    
