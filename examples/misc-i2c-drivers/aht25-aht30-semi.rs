//! Continuously read temperature from AHT25 and with semihosting hprintln.
//!
...
use aht30::{AHT20_DEFAULT_ADDR as AHT25_DEFAULT_ADDR, Aht20 as Aht25};
...
#[entry]
fn main() -> ! {
    hprintln!("AHT aht25-aht30-semi example");
    ...
    //  asm::bkpt();   
    let mut aht = Aht25::new(AHT25_DEFAULT_ADDR, i2c1, delay);
