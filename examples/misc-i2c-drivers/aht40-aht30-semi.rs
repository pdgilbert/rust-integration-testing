//! Continuously read temperature from AHT40 and with semihosting hprintln.
//!
...
use aht30::{AHT40_DEFAULT_ADDR, Aht40};
...
#[entry]
fn main() -> ! {
    hprintln!("AHT aht40-aht30-semi example");
    ...
    //  asm::bkpt();   
    let mut aht = Aht40::new(AHT40_DEFAULT_ADDR, i2c1, delay);
    //aht.calibrate().expect("sensor calibrate failed.");  no calibration function in aht40
