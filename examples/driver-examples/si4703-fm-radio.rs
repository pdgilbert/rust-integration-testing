...
use rust_integration_testing_of_examples::setup::{Peripherals, LED, Delay, DelayNs};
...
#[cfg(any(feature = "stm32f3xx", feature = "stm32f4xx", feature = "stm32g4xx",feature = "stm32h7xx"))]
