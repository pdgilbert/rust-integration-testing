...
//!
//! Modified from 
//! https://github.com/eldruin/driver-examples/blob/master/stm32f3-discovery/examples/max30102-display-f3.rs
//!
//! This example uses I2C1.
//!
//! See code setup() functions below for the pin settings. On the STM32F3 Discovery board the pins are
//! ```
//! F3    <-> MAX30102 <-> Display
//! GND   <-> GND      <-> GND
//! +3.3V <-> +3.3V
//! +5V   <-> +5V       VCC/VDD  +5V or +3.3V
//! PB7   <-> SDA      <-> SDA
//! PB6   <-> SCL      <-> SCL
//! ```
//! Run with:
